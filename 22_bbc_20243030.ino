...
#define _DUTY_NEU 1357 // 1500
#define _DUTY_MIN 500 // 1000

#define _SERVO_ANGLE_DIFF  86  // Replace with |D - E| degree
#define _SERVO_SPEED       180  // servo speed

#define _BANGBANG_RANGE    175  // duty up and down for bangbang control
...
void loop()
{
  ...
  if (event_serial) {
    ...
    Serial.print("dcpi:"); Serial.print(duty_change_per_interval);
...
float volt_to_distance(int a_value)
{
  ...
  return 1187 + (-6.63*a_value) + 0.013*a_value*a_value + (-8.69E-06)*a_value*a_value*a_value;
}
